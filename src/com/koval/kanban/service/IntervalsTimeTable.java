...
public class IntervalsTimeTable {
    private static final LocalDateTime START_DATE_TIME = LocalDateTime.of(2024, Month.AUGUST, 1, 0, 0);
    private static final LocalDateTime END_DATE_TIME = LocalDateTime.of(2025, Month.SEPTEMBER, 1, 0, 0);
